...
const Home = () => {
  return <>
    ...
    <>
          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div className='flex gap-[30px] justify-end'>
              ...
              <div className='mt-[30px]'>
                ...
                <img src={heroImg03} alt='' className='w-full mb' />
      ...
      <section>
      {/* This section contains blurbs about the services that the Medicare provides. */}
        <div className='containter'>
          ...
          <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                unmatched, expert health care. From the lab to the clinc.</p>
        ...
        {/* Here is the about section, where it'll explain what the Medicare company is about. */}
        <section>
          <About />
        </section>
                ...
                md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:pb-[26px] rounded-[10px]'>
                  <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-[6px] lg:gap-3'>
                      ...
                      <p className='text-[10px] leading-[10px] lg:leading-5 text-headingColor font-[400]'>
                        10:00AM
                      </p>
                    </div>
        ...
        <section>
          <div className='container'>
            <div className='flex justify-between-gap-[50px] lg:gap-0'>
              <div className='w-1/2 hidden md:block'><img src={faqImg} alt=''></img></div>
